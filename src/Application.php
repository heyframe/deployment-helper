...
class Application extends SymfonyApplication
{
    ...
    {
        parent::__construct('HeyFrame Deployment Helper', InstalledVersions::getPrettyVersion('heyframe/deployment-helper') ?? 'development');
        ...
        $this->getDefinition()->addOption(new InputOption('project-config', null, InputOption::VALUE_REQUIRED, 'Path to .heyframe-project.yaml'));
    }
