...
class HeyFrameState
{
    ...
    {
        return InstalledVersions::isInstalled('heyframe/storefront');
    }
    ...
    public function getCurrentVersion(): string
    {
        if (InstalledVersions::isInstalled('heyframe/platform')) {
            return (string) InstalledVersions::getVersion('heyframe/platform');
        }

        return (string) InstalledVersions::getVersion('heyframe/core');
    }
