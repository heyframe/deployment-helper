...
use HeyFrame\Deployment\Config\ConfigFactory;
...
class ConfigFactoryTest extends TestCase
{
    ...
    public function testCreateWithProjectConfigOption(): void
    {
        ...
        $customConfigPath = __DIR__ . '/_fixtures/yml/.heyframe-project.yml';
    ...
    public function testCreateWithProjectConfigOptionRelativePath(): void
    {
        ...
        $config = ConfigFactory::create(__DIR__ . '/_fixtures', $this->createMockApplication('yml/.heyframe-project.yml'));

        static::assertTrue($config->extensionManagement->enabled);
        static::assertSame(['foo' => 'test'], $config->oneTimeTasks);
    }

    #[Env('SHOPWARE_PROJECT_CONFIG_FILE', '_fixtures/yml/.heyframe-project.yml')]
