...
class HeyFrameStateTest extends TestCase
{
    ...
    private HeyFrameState $state;

    protected function setUp(): void
    {
        $this->connection = $this->createMock(Connection::class);
        $this->state = new HeyFrameState($this->connection);
    }

    public function testHeyFrameIsNotInstalled(): void
    {
    ...
    public function testHeyFrameIsInstalled(): void
    {
        $this->connection
            ->expects($this->once())
